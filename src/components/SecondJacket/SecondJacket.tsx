...
import styles from "./SecondJacket.module.scss";
...
export const SecondJacket: React.FC = () => {
  ...
  return (
    <div className={jacket}>
      <img src="/icons/jacket-2.jpg" alt="jacket-2" className={img} />
      <div
