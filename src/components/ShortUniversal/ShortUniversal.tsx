...
import styles from "./ShortUniversal.module.scss";
...
export const ShortUniversal: React.FC = () => {
  ...
  return (
    <div className={short}>
      <img src="/icons/t-short-universal.jpg" alt="t-short-universal" className={img} />
      <div
